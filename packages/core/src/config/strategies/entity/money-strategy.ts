 ...
 * ## Range
 *
 * The DefaultMoneyStrategy uses an `int` field in the database, which puts an
 ...
 *
 * You can configure the precision of the stored values via the `precision` property of the strategy.
 ...
 * @example
 * ```ts
 * import { DefaultMoneyStrategy, FirelancerConfig } from '\@firelancerco/core';
 *
