...
/**
 * @description
 * A simple type-safe finite state machine. This is used internally to control the JobPost process, ensuring that
 * the state of JobPosts follows a well-defined behaviour.
 */
