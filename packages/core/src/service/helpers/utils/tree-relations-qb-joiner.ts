 ...
 * @template T - The entity type, extending FirelancerEntity for compatibility with Firelancer's data layer.
 *
 * Usage Notes:
 ...
 * ```
 */
export function joinTreeRelationsDynamically<T extends FirelancerEntity>(
