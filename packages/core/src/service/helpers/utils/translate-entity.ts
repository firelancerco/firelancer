 ...
 */
export function translateEntity<T extends Translatable & FirelancerEntity>(
    translatable: T,
    languageCode: LanguageCode | [LanguageCode, ...LanguageCode[]],
): Translated<T> {
    let translation: Translation<FirelancerEntity> | undefined;
    if (translatable.translations) {
        ...
        if (!translation) {
            ...
            // prevent errors when returning the entity.
 ...
 */
export function translateDeep<T extends Translatable & FirelancerEntity>(
    translatable: T,
    languageCode: LanguageCode | [LanguageCode, ...LanguageCode[]],
...
export type TreeNode = { children: TreeNode[] } & Translatable & FirelancerEntity;
