 ...
 * This method is able to perform additional logic to e.g. aggregate many jobs into a single job in order to de-duplicate work.
 *
 * @example
 * ```ts
 * // This is a buffer which will collect all the 'apply-collection-filters' jobs and buffer them.
 ...
 *         applyToChangedJobPostsOnly: referenceJob.data.applyToChangedJobPostsOnly,
 *       },
 *     });
 *
 ...
 * // trigger the 'apply-collection-filters' job, such as updating collection filters.
 *
